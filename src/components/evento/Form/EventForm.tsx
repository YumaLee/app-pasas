...
import { z } from "zod";
import { User, Users, MapPin, DollarSign, Save, Calendar } from "lucide-react";
...
function EventForm({ selectedFont, onFontSelect, onSettingsClick, eventData }: EventFormProps) {
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="bg-[#100229] rounded-lg p-4">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-purple-500/20 flex items-center justify-center">
                                <QuickActionPopover type="address" onSave={(value) => form.setValue("referencia", value)}>
                            ...
                            <div className="flex-1">
                                ...
                                />
                                <p className="text-sm text-white/50 mt-1">{form.watch("referencia")}</p>
                            </div>
                        </div>
                    </div>
